    ...
    <PageShell>
      ...
      >
        {/* =====================================================
            HERO
            ===================================================== */}
        <section className="py-20 px-6 lg:px-10 bg-transparent text-center">
          <p className="text-[14px] uppercase tracking-[0.3em] text-gold font-bold">
            Journal
          </p>
        ...
        {/* =====================================================
            FEATURED ARTICLE
            ===================================================== */}
        <section className="px-6 lg:px-10 bg-transparent">
          <Link
            to="/blog/$slug"
        ...
        {/* =====================================================
            FILTERS
            ===================================================== */}
        <section className="px-6 lg:px-10 mt-16 bg-transparent">
            ...
            <div className="flex flex-wrap gap-2">
              {CATS.map((c) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-full text-[11px] uppercase tracking-[0.15em] font-semibold transition-all ${cat === c
                      ? "bg-olive text-cream"
                      : "bg-white text-ink hover:bg-wheat/60"
                    }`}
                >
                  {c}
                </button>
        ...
        {/* =====================================================
            BLOG GRID + SIDEBAR
            ===================================================== */}
        <section className="pt-10 pb-20 px-6 lg:px-10 bg-transparent">
          <div className="mx-auto max-w-6xl grid lg:grid-cols-[1fr_300px] gap-10">
                  ...
                  {visible.map((a) => (
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        <h3 className="mt-2 font-display text-xl text-olive leading-snug">
                          {a.title}
                        </h3>
            ...
            <aside className="space-y-6 lg:sticky lg:top-28 self-start">
              ...
              <div className="bg-olive text-cream rounded-3xl p-7">
                <p className="text-[11px] uppercase tracking-[0.25em] text-wheat font-semibold">
                  From the kitchen
                </p>

                <h3 className="mt-3 font-display text-2xl leading-snug">
                  Get monthly recipes & restocks.
                </h3>

                <p className="mt-2 text-sm text-cream/80">
                  Slow emails, small joys. Once a month, never more.
                </p>
                  ...
                  {rest.slice(0, 4).map((a) => (
                    <li key={a.slug}>
                      ...
                      >
                        ...
                        <div>
                          <p className="text-sm font-semibold text-olive leading-snug group-hover:underline line-clamp-2">
                            {a.title}
                          </p>
